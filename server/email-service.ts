  ...
  async initialize() {
    try {
      ...
      if (!settings?.mailHost || !settings?.mailFromAddress) {
        ...
        console.log('   Please configure SMTP settings in System Setup');
        return false;
      }

      console.log('📧 Initializing email service...');
      console.log(`   Host: ${settings.mailHost}`);
      console.log(`   Port: ${settings.mailPort || '587'}`);
      ...
      console.error('   Please check your SMTP configuration in System Setup');
